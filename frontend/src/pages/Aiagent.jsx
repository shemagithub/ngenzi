...
const AIPropertyHub = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-8 sm:py-12">
        ...
        <div className="text-center mb-6 max-w-lg px-4">
          <h3 className="text-xl sm:text-2xl font-medium text-gray-800 dark:text-gray-200 mb-3 bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">
            {loadingStage === "properties"
        ...
        <div className="w-full max-w-xs sm:max-w-md h-2 sm:h-2.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden mb-6 shadow-inner px-4 sm:px-0">
          <div
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 p-4 sm:p-5 rounded-lg max-w-xs sm:max-w-md shadow-md mx-4 sm:mx-0">
          <div className="flex items-center mb-3">
            ...
            <h4 className="font-medium text-blue-800 dark:text-blue-300 text-sm sm:text-base">
              AI Processing
            </h4>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-16 sm:pt-20 pb-8 sm:pb-12 transition-colors duration-200">
      <AiHubSEO />
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 sm:mb-12 bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-lg sm:shadow-xl">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-md sm:shadow-lg">
        ...
        {searchError && (
          <div className="bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 p-4 rounded-lg mb-6 sm:mb-8 max-w-4xl mx-auto border border-red-100 dark:border-red-800 shadow-sm">
        ...
        <div ref={contentRef}>
          {!isLoading && searchPerformed && (
            <div className="space-y-8 sm:space-y-12">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 md:p-8">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800 dark:text-gray-200 flex items-center">
                  <Building className="mr-2 text-blue-600 dark:text-blue-400 flex-shrink-0" />
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-md p-4 sm:p-6 md:p-8">
                <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800 dark:text-gray-200 flex items-center">
                  <TrendingUp className="mr-2 text-blue-600 dark:text-blue-400 flex-shrink-0" />
          ...
          {!isLoading && !searchPerformed ? (
            <div className="bg-white dark:bg-gray-800 p-5 sm:p-8 rounded-lg sm:rounded-xl shadow-md max-w-4xl mx-auto text-center">
              <div className="mb-5 sm:mb-6">
                <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 bg-blue-50 dark:bg-blue-900/30 rounded-full flex items-center justify-center mb-3 sm:mb-4">
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="bg-gray-50 dark:bg-gray-800 p-4 sm:p-5 rounded-lg border border-gray-100 dark:border-gray-700">
    <div className="text-blue-600 dark:text-blue-400 mb-2 sm:mb-3">{icon}</div>
    <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-1.5 sm:mb-2 text-sm sm:text-base">
      {title}
    </h3>
